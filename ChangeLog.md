...
### 2018-02-08    jfinal cms4.3.0
1. 缓存加入redis支持
2. 第三方核心包升级：jfinal v3.0、beetl v2.7.11

### 2018-01-22    jfinal cms4.2.0
1. 优化论坛模板数据
2. 模板发布功能优化
...
### 2018-02-20 jfinal cms2.9.0
1. 重构为maven项目，升级为2.9.0

### 2018-02-20 jfinal cms2.8.0
1. 升级为2.8.0
...
### 2018-01-28 jfinal cms2.5.0
1. 升级为2.5.0。
12. 后台加入主题切换，bootstrap默认，黑色，flat-ui三个主题。

### 2018-01-20 jfinal cms2.4.0
1. 升级为2.4.0。
...
### 2018-01-14 mtgxxw2.1.1
1. 升级父类依赖，升级为2.1.1

### 2018-01-03 mtgxxw2.1.0
